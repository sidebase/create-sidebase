...
`
  ...
  <div>
    <h1${selectedModules.includes("tailwind") || selectedModules.includes("unocss") ? " class=\"text-4xlfont-sans\"" : ""}>Welcome to your sidebase app!</h1>${moduleIndexHtmlSnippets.length > 0 ? "\n" + moduleIndexHtmlSnippets.join("\n    ") : ""}
  </div>
</template>
`
